...
public class JSqlParserCommandConversionHandlerTest {
    ...
    public void commandToSql1() throws Exception {
        ...
        String sql = commandConversionHandler.convert(command);
    ...
    public void commandToSql2() throws Exception {
        ...
        String sql2 = commandConversionHandler.convert(command2);
    ...
    public void commandToSql3() throws Exception {
        ...
        String sql3 = commandConversionHandler.convert(command3);
    ...
    public void commandToSql4() throws Exception {
        ...
        String sql4 = commandConversionHandler.convert(command4);
    ...
    public void commandToSql5() {
        ...
        String sql5 = commandConversionHandler.convert(command5);
    ...
    public void commandToSql6() throws Exception {
        ...
        String sql6 = commandConversionHandler.convert(command6);
    ...
    public void commandToSql7() throws Exception {
        ...
        String sql7 = commandConversionHandler.convert(command7);
